...
export default function NotFound() {
  return (
    <Page
      ...
      lede="That address is not one this site has. Press Ctrl K, or ⌘K on a Mac, to search every driver, team, circuit, car, season and race at once — or pick up one of these."
    >
