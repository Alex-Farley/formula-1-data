...
<!-- fig:yes_share -->99.4%<!-- /fig --> of the <!-- fig:sourced_rows -->118,356<!-- /fig --> sourced rows carry a licence that permits
...
| Class | Rows | Share |
|---|---:|---:|
| `yes` — redistributable on the terms given | <!-- fig:yes_rows -->117,689<!-- /fig --> | <!-- fig:yes_share -->99.4%<!-- /fig --> |
