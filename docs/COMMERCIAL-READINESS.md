...
<!-- fig:yes_share -->99.2%<!-- /fig --> of the <!-- fig:sourced_rows -->121,288<!-- /fig --> sourced rows carry a licence that permits
redistribution outright. The remaining <!-- fig:facts_only_share -->0.8%<!-- /fig --> cite an official source as the
**authority for a fact** and hold none of that source's prose. Nothing in the
committed database may not be published.

| Class | Rows | Share |
|---|---:|---:|
| `yes` — redistributable on the terms given | <!-- fig:yes_rows -->120,317<!-- /fig --> | <!-- fig:yes_share -->99.2%<!-- /fig --> |
| `facts-only` — the facts, not the expression | <!-- fig:facts_only_rows -->971<!-- /fig --> | <!-- fig:facts_only_share -->0.8%<!-- /fig --> |
...
<!-- fig:facts_only_rows -->971<!-- /fig --> rows cite `formula1.com` (<!-- fig:facts_only_formula1 -->894<!-- /fig -->) or `fia.com` (<!-- fig:facts_only_fia -->77<!-- /fig -->), the two sources whose
...
**All <!-- fig:facts_only_rows -->971<!-- /fig --> are (a). None is (b).** The breakdown, across <!-- fig:facts_only_tables -->11<!-- /fig --> tables — every
...
| `claims` | <!-- fig:fo_claims -->276<!-- /fig --> | formula1.com | career totals, one figure a row: the figures `drivers` carries as `*_external` for the drivers whose rows cite formula1.com, including the wins, poles and podiums of seven 2026 drivers read from their driver pages | — |
