...
<!-- fig:yes_share -->99.4%<!-- /fig --> of the <!-- fig:sourced_rows -->118,482<!-- /fig --> sourced rows carry a licence that permits
...
| `facts-only` — the facts, not the expression | <!-- fig:facts_only_rows -->692<!-- /fig --> | <!-- fig:facts_only_share -->0.6%<!-- /fig --> |
...
<!-- fig:facts_only_rows -->692<!-- /fig --> rows cite `formula1.com` (<!-- fig:facts_only_formula1 -->618<!-- /fig -->) or `fia.com` (<!-- fig:facts_only_fia -->74<!-- /fig -->), the two sources whose
...
**All <!-- fig:facts_only_rows -->692<!-- /fig --> are (a). None is (b).** The breakdown, across <!-- fig:facts_only_tables -->10<!-- /fig --> tables — every
