...
<!-- fig:yes_share -->99.4%<!-- /fig --> of the <!-- fig:sourced_rows -->120,534<!-- /fig --> sourced rows carry a licence that permits
...
| Class | Rows | Share |
|---|---:|---:|
| `yes` — redistributable on the terms given | <!-- fig:yes_rows -->119,819<!-- /fig --> | <!-- fig:yes_share -->99.4%<!-- /fig --> |
...
| `claims` | <!-- fig:fo_claims -->20<!-- /fig --> | formula1.com | career wins, poles and podiums of the current drivers, one figure a row — the figures `drivers` carries as `*_external`, with the source of each | — |
