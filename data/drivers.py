...
CHAMPIONS = [
    ...
    ("norris", "Lando Norris", "United Kingdom", "GBR", "1999-11-13", None, 2019, None,
     ...
     "A first win at Miami in 2024, then the 2025 title by two points from Verstappen with team-mate Piastri third — the closest top three in the sport's history.", "medium"),
]
...
OTHER_DRIVERS = [
    ...
    ("hulkenberg", "Nico Hulkenberg", "Germany", "GER", "1987-08-19", None, 2010, None, 0, 1, 0, "active",
     "Took pole on his eighth start for Williams in 2010; a first podium came at Silverstone in 2025. Won Le Mans outright in 2015.", "medium"),
