...
CHAMPIONS = [
    ...
    ("ascari", "Alberto Ascari", "Italy", "ITA", "1918-07-13", "1955-05-26", 1950, 1955,
     ...
     "Won every championship race he entered from Belgium 1952 to Belgium 1953, a run that stood as the record until Verstappen in 2023. Killed testing a Ferrari sports car at Monza four days after surviving a plunge into Monaco harbour.", "high"),
    ...
    ("surtees", "John Surtees", "United Kingdom", "GBR", "1934-02-11", "2017-03-10", 1960, 1972,
     ...
     "The only World Champion on both two wheels and four: seven times on MV Agusta motorcycles, once in a Ferrari. Later ran his own constructor, Team Surtees.", "medium"),
    ...
    ("schumacher", "Michael Schumacher", "Germany", "GER", "1969-01-03", None, 1991, 2012,
     ...
     "Champion with Ferrari every year from 2000 to 2004. Held the record for wins (91) until 2020. Suffered a severe brain injury skiing in December 2013.", "high"),
    ...
    ("vettel", "Sebastian Vettel", "Germany", "GER", "1987-07-03", None, 2007, 2022,
     ...
     "Youngest ever World Champion at 23 (2010) and youngest four-time champion. Won every race from Belgium to Brazil in 2013, equalling Ascari's run.", "high"),
...
OTHER_DRIVERS = [
    ...
    ("montoya", "Juan Pablo Montoya", "Colombia", "COL", "1975-09-20", None, 2001, 2006, 7, 13, 0, "retired",
     "Won the Indianapolis 500 and CART title before F1, and passed Schumacher around the outside at Interlagos in his first season.", "high"),
