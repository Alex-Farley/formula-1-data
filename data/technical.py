...
GLOSSARY = [
    ...
    ("DSQ", "results", "Disqualified: took part and was then removed from the result, usually for a technical or sporting breach found afterwards. In a championship table, a driver or team removed from the classification - Tyrrell in 1984, and Michael Schumacher in 1997, whose points stand without a position."),
