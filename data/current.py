...
# same value, and no value without one - a driver figure typed from
# reference records nobody named included, since PM-57 (#624) checked each
# against a named source and removed the two none gives. A new kind of
# claim is therefore a declaration, and a
