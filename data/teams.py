...
CONSTRUCTORS = [
    ...
    ("aston-martin", "Aston Martin", "Aston Martin Aramco Formula One Team", "United Kingdom", "Silverstone, United Kingdom", 2021, None,
     0, 0, 0, None, "silverstone", 1,
     "The current entity dates from Lawrence Stroll's 2021 rebrand of Racing Point. Aston Martin also entered briefly as a constructor in 1959-60 with no success. Adrian Newey joined as team principal for 2026.", "medium"),
    ...
    ("penske", "Penske", "Penske Cars", "United States", "Poole, United Kingdom", 1974, 1976,
     1, 0, 0, None, "penske-chain", 0,
     "Won the 1976 Austrian GP with John Watson, then left for American racing.", "medium"),
